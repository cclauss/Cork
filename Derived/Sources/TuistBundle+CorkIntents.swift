...
/// Since CorkIntents is a static library, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Cork_CorkIntents"
    var candidates = [
    ...
    fatalError("unable to find bundle named Cork_CorkIntents")
}()
}// MARK: - Objective-C Bundle Accessor
@objc
public class CorkIntentsResources: NSObject {
